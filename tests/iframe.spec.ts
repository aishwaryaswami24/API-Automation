...
test('nested frame',async({page})=>{
    ...
    await childFrames[0].locator('//div[@id="i6"]//div[@class="AB7Lab Id5V1"]').check({force:true});
    await childFrames[0].locator('//div[@id="i21"]//div[@class="PkgjBf MbhUzd"]').check({force:true});
